      ...
      <ConnectedAddress />
        <div className={styles.migrationContainer}>
          ...
          <ul style={{ listStyleType: "disc", paddingLeft: "20px", }}>
            ...
            <li style={{marginTop: "5px"}}><strong>Step 5:</strong>Click Migrate, to migrate your allocation from the old $ARBINU contract to the new one.</li>
            ...
            <li style={{marginTop: "5px"}}><strong>Step 8:</strong>1-to-1 swap your $ARBINU (V1) for $ARBINU (v2). The new $ARBINU (v2) will be available to view in your wallet after.</li>
          </ul>
          ...
          <h4>
          You will receive: {Number(depositAmount).toLocaleString()} $ARBINU (V2)
          </h4>
          <div 
          style={{
            display: "flex",
